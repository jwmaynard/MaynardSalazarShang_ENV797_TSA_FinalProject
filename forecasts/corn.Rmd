...
# sarima on last 50 years only
recent_training_ts <- tail(yield_training_ts, 50)
recent_sarima_corn <- auto.arima(recent_training_ts)
recent_sarima_forecast <- forecast(object = recent_sarima_corn, h = nobs_test)
checkresiduals(recent_sarima_forecast)
autoplot(yield_ts)+
  autolayer(recent_sarima_forecast)+ylab("Corn Yield")
...
recent_sarima_accuracy <- accuracy(recent_sarima_forecast, yield_test_ts)
